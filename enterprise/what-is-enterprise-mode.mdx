...
<CardGroup cols={2}>
  <Card title="Fixed Fee" icon="square-1">
    Pay a fixed fee for up to 50,000 daily transactions, avoiding the volatility
    of demand-driven fees.
  </Card>
  <Card title="Gasless Transactions" icon="square-2">
    Standard Ethereum transactions with 0 gas. No sepcial wallets or plugins
    required.
  </Card>
  ...
  <Card title="Predictable Pricing" icon="square-4">
    Pay a fixed fee in stablecoins for a set amount of gas units. No surprise
    gas spikes, no spikes in cost.
  </Card>
</CardGroup>
